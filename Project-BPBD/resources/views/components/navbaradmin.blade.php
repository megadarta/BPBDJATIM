<div class="navbar d-flex  ">
  ...
  <div class="menu-navbar-admin">
      <a class="text-menu-navbar"><img class="gambar-atas-navbar" src="{{ asset('assets/maps.png') }}">Maps</a>
      
      <a class="text-menu-navbar"><img class="gambar-atas-navbar" src="{{ asset('assets/data.png') }}">Data</a>
  </div>
